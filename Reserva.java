...
public class Reserva {
	...
	public String toString() {
		String reserva="";
	    reserva+="Numero da Reserva: "+this.numReserva+"\n";
	    reserva+="Data de voo: "+this.dataVoo+"\n";
	    reserva+="Hora de voo: "+this.horaVoo+"\n";
		reserva+="Preco da passagem: "+this.preco+"\n";
		reserva+="Classe do voo: "+this.classeVoo+"\n";
		reserva+="Poltrona :"+this.poltrona+"\n";
		reserva+="Origem: "+this.origem+"\n";
		reserva+="Destino: "+this.destino+"\n";
